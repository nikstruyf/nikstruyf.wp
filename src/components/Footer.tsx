            ...
            <ul className="nav justify-content-center bg-dark" style={{height: "50px"}}>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={PhoneIcon} alt="" style={{height: "29px"}}/> 
                    </a>
                </li>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={EmailIcon} alt="" style={{height: "30px"}}/> 
                    </a>
                </li>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={GithubIcon} alt="" style={{height: "32px"}}/> 
                    </a>
                </li>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={LinkedinIcon} alt="" style={{height: "30px"}}/> 
                    </a>
                </li>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={FacebookIcon} alt="" style={{height: "30px"}}/> 
                    </a>
                </li>
                <li className="nav-item mx-1">
                    <a className="nav-link active" href="#" style={{color: "white"}}>
                        <img src={InstagramIcon} alt="" style={{height: "30px"}}/> 
                    </a>
                </li>
            </ul>
        </>
